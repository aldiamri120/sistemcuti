        ...
        <div class="col-12">
                            ...
                            <table id="scroll-horizontal-datatable" class="table table-hover mb-0 w-100 nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($d['jatah_cuti_tahunan'] == 0 or $d['tahun'] != date('Y')) : ?>
                                        <td>
                                            <p class="text-warning">BELUM DIALOKASIKAN</p>
                                        </td>

                                        <?php else : ?>
                                        <td><?= $d['jatah_cuti_tahunan'] ?> HARI</td>
                                        <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <button onclick="cuti('<?= $d['id_user'] ?>','<?= $d['nama'] ?>')"
                                                class="btn btn-success btn-sm">Alokasikan Cuti Tahunan</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" id="standard-modalLabel">Pegawai</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="jabatan" name="jabatan" required>
                                    ...
                                    <?php if (!str_contains($d['nama_jabatan'], "pengawas") and !str_contains($d['nama_jabatan'], "admin") and !str_contains($d['nama_jabatan'], "pptk pjlp") and !str_contains($d['nama_jabatan'], "ka pusyankeswannak") and !str_contains($d['nama_jabatan'], "kasubbag tu") and !str_contains($d['nama_jabatan'], "kasatlak")) : ?>
            ...
            <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="standard-modalLabel">Pegawai/Admin</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="jabatan_edit" name="jabatan">
                                    ...
                                    <option value="">Pilih Jabatan...</option>
                                    <?php foreach ($data_jabatan as $d) : ?>
                                    <?php if (!str_contains($d['nama_jabatan'], "pengawas") and !str_contains($d['nama_jabatan'], "admin") and !str_contains($d['nama_jabatan'], "pptk") and !str_contains($d['nama_jabatan'], "ka pusyankeswannak") and !str_contains($d['nama_jabatan'], "kasubbag tu") and !str_contains($d['nama_jabatan'], "kasatlak")) : ?>
                                    <option value="<?= $d['id_jabatan'] ?>"><?= strtoupper($d['nama_jabatan']) ?>
                                    </option>
                                    <?php endif; ?>
                                    <?php endforeach; ?>
            ...
            function cuti(id, nama) {
                // confirm 
                var conf = confirm("Alokasikan cuti tahunan untuk " + nama + " di tahun ini ?");
                if (conf) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (resp.status == "1") {
                                alert("Cuti untuk " + nama + " berhasil dialokasikan");
                                location.reload();
                            } else {
                                alert("Gagal mengalokasikan cuti")
                            }
                        },
                    });
                }
